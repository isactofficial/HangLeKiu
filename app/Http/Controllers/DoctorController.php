...
class DoctorController extends Controller
{
    ...
    private function validateRequest(Request $request, $id = null)
    {
        return $request->validate([
            ...
            'shadow_image'        => 'nullable|image|mimes:png,webp|max:3072',
            'badge_1'             => 'nullable|image|mimes:jpg,jpeg,png,webp|max:3072',
            'badge_2'             => 'nullable|image|mimes:jpg,jpeg,png,webp|max:3072',
            'ttd'                 => 'nullable|image|mimes:jpg,jpeg,png,webp|max:3072',
