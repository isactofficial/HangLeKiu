...
class PatientController extends Controller
{
	...
	public function update(Request $request, string $id): JsonResponse
	{
		...
		$authResponse = $this->authorizePatientWrite($patient);
		if ($authResponse) {
			return $authResponse;
		}
	...
	private function authorizePatientWrite(Patient $patient): ?JsonResponse
	{
		if (! Auth::check()) {
			return response()->json([
				'success' => false,
		...
		if ($role === 'user' && (string) $currentUser->id === (string) $patient->user_id) {
			return null;
		}
