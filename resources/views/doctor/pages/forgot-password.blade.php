...
<head>
    ...
    <title>Lupa Password Dokter - Hanglekiu</title>
...
<body>
    <div class="card">
        ...
        <p class="desc" style="color: #C58F59;">Masukkan email dokter Anda untuk menerima link reset.</p>
        ...
        <form method="POST" action="{{ route('doctor.password.email') }}">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" placeholder="dokter@gmail.com" required>
            </div>
            <button type="submit" class="btn">Kirim Link Reset</button>
        </form>
        <a href="{{ route('doctor.login') }}" class="back-link">Kembali ke Login</a>
    </div>
</body>
</html>