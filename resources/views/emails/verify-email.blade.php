...
<head>
    ...
    <title>Verifikasi Email - HangLeKiu</title>
    <style>
...
<body>
    <div class="email-wrapper">
        <div class="email-card">
            ...
            <div class="content">
                <h2>Halo, {{ $userName }}!</h2>
                <p>Terima kasih telah mendaftar di <strong>HangLeKiu Dental Clinic</strong>.</p>
                <p>Untuk menyelesaikan proses pendaftaran, silakan verifikasi alamat email Anda dengan mengklik tombol di bawah ini:</p>
                
                <div class="btn-container">
                    <a href="{{ $verificationUrl }}" class="btn" style="color: #ffffff;">Verifikasi Email</a>
                </div>

                <p>Link verifikasi ini hanya berlaku selama <strong>24 jam</strong> ke depan.</p>
