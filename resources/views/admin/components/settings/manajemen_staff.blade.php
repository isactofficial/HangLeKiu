...
<div class="ms-header-row">
    <div>
        <h2 class="ms-title">Staff & Hak Akses</h2>
        <p class="ms-subtitle">Manajemen akun staff dan informasi hak akses sistem</p>
    </div>
    <div class="ms-actions-row" id="staff-actions-row">
        <div >
...
<div class="ms-tabs">
    <div class="ms-tab-item active" data-tab="tab-daftar-staff">Daftar Akun Staff</div>
    <div class="ms-tab-item" data-tab="tab-hak-akses">Informasi Hak Akses</div>
</div>

<div id="tab-daftar-staff" class="ms-tab-content active">
...
</div> {{-- End of tab-daftar-staff --}}

<div id="tab-hak-akses" class="ms-tab-content">
    <div class="ha-header-row">
        <div>
            <h2 class="ha-title">Hak Akses Role</h2>
            <p class="ha-subtitle">Informasi fitur dan akses berdasarkan role user</p>
        </div>
    </div>
    ...
    <div class="ha-table-card">
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;">
                            <div class="ha-action-row" style="justify-content:flex-end;">
                                ...
                                <button class="ha-icon-btn del" title="Hapus" disabled style="opacity:0.3; cursor:not-allowed;">
        ...
        <div class="ha-pagination">
            ...
            <div class="ha-page-info">1–5 dari 5 data</div>
            <div class="ha-page-controls">
                ...
                <button class="ha-page-btn" disabled><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M9 18l6-6-6-6"/></svg></button>
                <button class="ha-page-btn" disabled><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M13 17l5-5-5-5M6 17l5-5-5-5"/></svg></button>
            </div>
        </div>
    </div>
</div> {{-- End of tab-hak-akses --}}
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Tab Switching Logic
        const tabItems = document.querySelectorAll('.ms-tab-item');
        const tabContents = document.querySelectorAll('.ms-tab-content');
        const staffActionsRow = document.getElementById('staff-actions-row');
        ...
        tabItems.forEach(item => {
            item.addEventListener('click', () => {
                ...
                // Show/hide "Tambah Akun" button based on tab
                if (staffActionsRow) {
                    staffActionsRow.style.display = (target === 'tab-daftar-staff') ? 'flex' : 'none';
                }
            });
        });
    });
