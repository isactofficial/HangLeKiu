            ...
            <div class="max-w-7xl mx-auto px-6 md:px-10 lg:px-16 h-full">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center h-full">
                    ...
                    <div class="relative flex justify-center items-end h-full" style="min-height: 640px;">
                        ...
                        {{-- Carousel Container --}}
                        <div id="doctor-carousel" class="relative w-full flex justify-center items-end overflow-hidden"
                            style="height: 640px;">
                    ...
                    <div>
                        <h2 id="doctor-name"
                            class="text-4xl md:text-5xl font-bold text-[var(--font-color-primary)] leading-tight mb-1">
                            Jenny Wilson Sp.Ort
                        </h2>
                        <p id="doctor-subtitle"
                            class="text-[18.75px] italic font-medium text-[var(--font-color-secondary)] mb-6">
            ...
            <div class="bg-[#E5D6C5] rounded-3xl px-10 py-11 md:px-14 md:py-11">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-10">
                    ...
                    <div
                        ...
                        <button
                            class="text-[18.75px] font-medium text-[#C58F59] flex items-center gap-1.5 hover:opacity-75 transition-opacity ml-auto">
                            Info Selengkapnya
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                ...
                <div class="flex justify-center">
                    <button
                        class="px-8 py-3 bg-[#C58F59] hover:bg-[#A0703E] text-white text-[18.75px] font-normal rounded-full transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5">
                        Layanan Lainnya
                    </button>
                </div>
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <div class="flex items-center justify-center px-3 py-2 bg-white rounded-lg shadow-sm">
                    <img src="{{ asset('images/copy-of-copy-of-garda-medika-01-melinda-nitbani-1200x480 1.svg') }}"
                        alt="Garda Medika" class="h-18 object-contain">
                </div>
                <div class="flex items-center justify-center px-3 py-2 bg-white rounded-lg shadow-sm">
        ...
        <div class="max-w-7xl mx-auto p-[32px]">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
                ...
                <div class="text-center">
                    ...
                    <ul class="space-y-3">
                        <li><a href="#"
                                class="text-[16px] font-regular text-[#582C0C] hover:text-[#582C0C] transition-colors">Beranda</a>
                        </li>
                        <li><a href="#pelayanan"
                                class="text-[16px] font-normal text-[#582C0C] hover:text-[#582C0C] transition-colors">Pelayanan</a>
                        </li>
                        <li><a href="#klinik"
                                class="text-[16px] font-normal text-[#582C0C] hover:text-[#582C0C] transition-colors">Klinik</a>
                        </li>
                        <li><a href="#klinik"
                                class="text-[16px] font-normal text-[#582C0C] hover:text-[#582C0C] transition-colors">Profil
                                Dokter</a></li>
                        <li><a href="#"
                                class="text-[16px] font-normal text-[#582C0C] hover:text-[#582C0C] transition-colors">Artikel</a>
                        </li>
                    </ul>
                </div>
