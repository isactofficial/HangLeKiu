        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 text-center md:text-left">
            ...
            <div class="flex flex-col items-center md:items-start">
                ...
                <div class="flex items-center justify-center md:justify-start gap-3">
                    ...
                    <a href="https://maps.app.goo.gl/audBsxjNhuRwebng8"
                        class="w-10 h-10 bg-[#582C0C] rounded-full flex items-center justify-center hover:opacity-80 transition-opacity" target="_blank" rel="noopener">
                        <svg class="w-5 h-5 text-[#E5D6C5]" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 6.16 11.37 6.43 11.62.36.33.88.33 1.24 0C12.84 20.37 19 14.25 19 9c0-3.87-3.13-7-7-7zm0 9.5A2.5 2.5 0 1 1 12 6a2.5 2.5 0 0 1 0 5z" />
                        </svg>
                    </a>
