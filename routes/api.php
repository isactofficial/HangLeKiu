...
Route::prefix('test')->group(function () {
    Route::get('/appointments', function () {
        try {
            $appointments = \App\Models\Appointment::with(['patient', 'doctor', 'poli', 'paymentMethod'])->limit(5)->get();
    ...
    Route::get('/check-tables', function () {
        try {
            ...
            return response()->json([
                ...
                'tables' => $tables ?? 'SQLite - use pragma table_info()'
            ]);
        } catch (\Exception $e) {
